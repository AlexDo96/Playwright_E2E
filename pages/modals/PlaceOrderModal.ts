...
export class PlaceOrderModal extends CartPage {
   ...
   constructor(page: Page) {
      ...
      this.crossButton = page.locator('//div[@id="orderModal"]//button[@aria-label="Close"]')
      ...
      this.closeButton = page.locator('//div[@id="orderModal"]//button[contains(text(),"Close")]')
      this.purchaseButton = page.locator('//div[@id="orderModal"]//button[contains(text(),"Purchase")]')
      ...
      this.information = page.locator('[class="lead text-muted "]')
