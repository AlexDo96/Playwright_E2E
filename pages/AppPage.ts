...
export class AppPage extends LoginPage {
   ...
   readonly nexus6Item: Locator
   readonly samsungGalaxy7Item: Locator
   readonly samsungGalaxy6Item: Locator
   readonly iphone6Item: Locator
   readonly sonyXperiaZ5Item: Locator
   readonly htcOne9Item: Locator
   readonly sonyVaio5Item: Locator
   readonly sonyVaio7Item: Locator
   readonly appleMonitorItem: Locator
   readonly macBookAirItem: Locator
   readonly dellI7Item: Locator
   ...
   constructor(page: Page) {
      ...
      this.samsungGalaxy6Item = page.locator('[class="card-title"]>[href="prod.html?idp_=1"]')
      this.nokiaLumiaItem = page.locator('[class="card-title"]>[href="prod.html?idp_=2"]')
      this.nexus6Item = page.locator('[class="card-title"]>[href="prod.html?idp_=3"]')
      this.samsungGalaxy7Item = page.locator('[class="card-title"]>[href="prod.html?idp_=4"]')
      this.iphone6Item = page.locator('[class="card-title"]>[href="prod.html?idp_=5"]')
      this.sonyXperiaZ5Item = page.locator('[class="card-title"]>[href="prod.html?idp_=6"]')
      this.htcOne9Item = page.locator('[class="card-title"]>[href="prod.html?idp_=7"]')
      this.sonyVaio5Item = page.locator('[class="card-title"]>[href="prod.html?idp_=8"]')
      this.sonyVaio7Item = page.locator('[class="card-title"]>[href="prod.html?idp_=9"]')
      ...
      this.dellI7Item = page.locator('[class="card-title"]>[href="prod.html?idp_=12"]')
   ...
   async clickTwiceSliderWindowPreviousButton(): Promise<void> {
      await this.clickSliderWindowPreviousButton()
      await this.clickSliderWindowPreviousButton()
   }
}
